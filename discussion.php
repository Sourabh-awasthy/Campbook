...
if(!empty($Description) && !empty($Name)){
  $sql = "INSERT INTO `kbh_data`.`discussion` ( `Name`, `Description`, `Mobile_Number`) VALUES ( '$Name' , '$Description' ,  '$Mobile_Number')";
...
<div class="main">
  ...
  <table class="table">
    ...
    <?php 
    $query = mysqli_query($con, "SELECT * FROM `kbh_data`.`discussion`");
