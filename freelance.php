...
if(!empty($Description) && !empty($Price) && !empty($Name)){
  $sql = "INSERT INTO `kbh_data`.`freelance` ( `Name`, `Description`, `Price`, `Mobile_Number`) VALUES ( '$Name' , '$Description' , '$Price', '$Mobile_Number')";
...
<body>
    ...
    <div class="main">
      ...
      <table class="table">
        ...
        <?php 
        $query = mysqli_query($con, "SELECT * FROM `kbh_data`.`freelance`");
